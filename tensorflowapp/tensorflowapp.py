...
class Tensorflowapp(ChrisApp):
    ...
    test tf apps.
    """
    AUTHORS         = 'sub-mod (smodeel@redhat.com)'
    ...
    CATEGORY        = 'tensorflow'
    TYPE            = 'ds'
    DESCRIPTION     = 'Sample Tensorflow application plugin for Chris Project.'
    ...
    def define_parameters(self):
        ...
        self.add_argument('--inference_path', dest='inference_path', type=str, optional=False,
                          help='path of images')
